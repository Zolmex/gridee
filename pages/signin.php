...
<body>
    ...
    <main class="login-content" role="main">
        <div class="login-container">
            <section class="login-panel-container" aria-labelledby="welcome-heading">
                <header class="login-panel-header">
                    <img src="../images/logo-full.png" alt="Gridee logo">
                    <p id="welcome-heading">Welcome back</p>
                </header>
                <div class="login-panel">
                    <form class="login-panel-input-grid" action="/pages/signin.php" method="post" aria-label="Formulario de inicio de sesión">
                        ...
                        <div class="login-panel-input-field-username">
                            ...
                            <input id="login-panel-username" name="username" type="text" placeholder="Username" required aria-required="true" autocomplete="username">
                        </div>
                        ...
                        <div class="login-panel-input-field-password">
                            ...
                            <input id="login-panel-password" type="password" name="password" placeholder="Password" required aria-required="true" autocomplete="current-password">
                        </div>
                        <button type="submit" class="login-panel-signin-button" aria-label="Iniciar sesión">Sign In</button>
                    </form>
